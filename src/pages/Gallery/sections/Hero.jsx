...
export default function Hero() {
  ...
  return (
    <section className="ab-hero">
      <img src={heroBg} alt="Dr.Roshan's Dental Care Gallery" className="ab-hero__bg" />
      <div className="ab-hero__overlay" />

      <div className="container ab-hero__content">
        <div className="ab-hero__left">
          <p className="eyebrow" style={{ color: 'rgba(255,255,255,0.75)', marginBottom: '10px' }}>Gallery</p>
          <h1>Moments of Smiles <br />We're Proud Of</h1>
          <p style={{ color: 'rgba(255,255,255,0.72)', fontSize: '15px', fontWeight: 600, margin: '10px 0 0', lineHeight: 1.7 }}>
            A glimpse of our clinic, advanced technology,<br />and the beautiful smiles we create every day.
          </p>
